		...
		for ($hour = $day_time -> start_hour; $hour <= $day_time -> end_hour; $hour++) 
		{
			for ($minute = 0; $minute <= 30; $minute += 30) 
			{
				for ($matched = 0; $matched <= count($booked); $matched++) 
				{
									...
									if (($service_gap_sh == $gap_hour) && ($service_gap_sm == $gap_minute)) {
										for ($j = 0; $j < $gap_interval; $j++) {
											...
											else 
											{
												...
												if ($blktime != "") 
												{
													echo "<a class=\"hourschoice_res1 \" rel=\"1\"  href='#' onclick='TimeClick(this);'>" . ($hour < 10 ? "0" . $hour : $hour) . ":" . ($minute < 30 ? "0" . $minute : $minute) . "</a>";
												}
												else if ($booking == 0) 
												{
													if ($gap >= $tottim) 
					...
					{
						echo "<a class=\"hourschoice_res1 \" rel=\"1\"  href='#' onclick='TimeClick(this);'>" . ($hour < 10 ? "0" . $hour : $hour) . ":" . ($minute < 30 ? "00" : $minute) . "</a>";
					} 
					else if ($bookinggg == 0) 
					{
						echo "<a class=\"hourschoice_res \" rel=\"1\" id=\"time_$time\" href='#' onclick='TimeClick(this);'>" . ($hour < 10 ? "0" . $hour : $hour) . ":" . ($minute < 30 ? "00" : $minute) . "</a>";
									...
									if (($service_gap_sh == $gap_hour) && ($service_gap_sm == $gap_minute)) {
										for ($j = 0; $j < $gap_interval; $j++) {
											...
											else 
											{
												...
												if ($blktime != "") 
												{
													echo "<a class=\"hourschoice_res1 \" rel=\"1\"  href='#' onclick='TimeClick(this);'>" . ($hourcheck < 10 ? "0" . $hourcheck : $hourcheck) . ":" . ($minute < 30 ? $mntt : $minute) . "</a>";
												} 
												else if ($booking == 0) 
												{
													if ($gap >= $tottim) 
													...
													{
														echo "<a class=\"hourschoice_res1 \" rel=\"1\"  href='#' onclick='TimeClick(this);'>" . ($hour < 10 ? "0" . $hourcheck : $hourcheck) . ":" . ($minute < 30 ? $mntt : $minute) . "</a>";
													}
												} 
												else
												{
