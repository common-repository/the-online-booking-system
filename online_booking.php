...
<?php
	...
	else if($_REQUEST['action'] == "checkemaill")
	{
		...
		else
		{
			...
			$ur = $lnam ."&".$mob ."&".$tele ."&".$add1 ."&".$add2 ."&". $cty. "&".$post . "&" .$cntry;
			echo $ur;
		}
	}
							...
							<div class="widget-wp-obs_body" id="newcustomer" style="display:block;">
								...
								<?php
										...
										(
												$wpdb->prepare
												(
														"SELECT * FROM ".$wpdb->prefix."sm_booking_field where status = 1"
