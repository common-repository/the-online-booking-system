	...
	jQuery.extend(jQuery.fn, {
		...
		miniColors: function(o, data) {
			...
			var create = function(input, o, data) {
				...
				// Create trigger
				var trigger = jQuery('<a class="miniColors-trigger" style="background-color:  #'+ color +';position:absolute;left:155px;' + color + '" href="#"></a>');
			...
			var show = function(input) {
				...
				jQuery(document).bind('mousedown.miniColors touchstart.miniColors', function(event) {
					...
					var testSubject = jQuery(event.target).parents().andSelf();
			...
			var hide = function(input) {
				...
				if( !input ) input = jQuery('.miniColors');
